...
std::vector<node> segment_tree(4*1000005);
string str;
node united(node a,node b)
{
    node papa;
    ll temp = min(a.o,b.c);
    papa.ans = a.ans+b.ans+temp;
    papa.o = a.o+b.o-temp;
    papa.c = a.c+b.c-temp;
    return papa;
}
void build(ll index,ll start,ll end)
{
    ...
    if(start==end)
    {
        segment_tree[index].ans=0;
        segment_tree[index].o=0;
        segment_tree[index].c=0;
        if(str[start]=='(')
            segment_tree[index].o=1;
        else 
            segment_tree[index].c=1;
        return;
    }
...
int main()
{
    ...
    { 
        ...
        for(ll i=0;i<q;i++)
        {
            ...
            a--;
            b--;
            cout << query(0,0,n-1,a,b).ans*2 << endl;
        }
