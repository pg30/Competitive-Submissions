...
bool vis[maxn][maxm];
char arr[maxn][maxm], brr[maxn][maxm];
void solve()
{
    ll n, m;
    cin >> n >> m;
    ...
    //     for (ll j = 0; j < 4; j++)
    //     {
    //         ll x = r1 + dx[j], y = c1 + dy[j];
    //         if (isSafe(x, y, n, m) && arr[x][y] == '.')
    //         {
    //             cout << "YES" << endl;
    //             return;
    //         }
    ...
    // if ((abs(r2 - r1) == 1 && abs(c2 - c1) == 0) || (abs(r2 - r1) == 0 && abs(c2 - c1) == 1))
    // {
    //     if (arr[r2][c2] == 'X')
    //     {
    //         cout << "YES" << endl;
