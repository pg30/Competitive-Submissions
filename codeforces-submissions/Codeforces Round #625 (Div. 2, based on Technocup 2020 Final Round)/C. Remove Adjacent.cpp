...
int main()
{
    ...
    while(t--)
    {
        ...
        for(ll i=25;i>=0;i--)
        {
            ...
            for(auto j:arr[i])
            {
                ll first = j-1,last = j+1;
                while(first>=0)
                {
                    if(!done[first] && (str[first]-'a')-i!=1) break;
                    if((str[first]-'a')-i==1 && !done[first])
                    {
                        ans++;
                        done[first]=1;
                    }
                ...
                while(last<n)
                {
                    if(!done[last] && (str[last]-'a')-i!=1) break;
                    if(!done[last] && (str[last]-'a')-i==1)
                    {
                        ans++;
                        done[last]=1;
                    }
