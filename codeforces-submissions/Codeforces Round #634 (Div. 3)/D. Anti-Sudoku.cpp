...
int main()
{
    ...
    while (t--)
    {
        ...
        arr[0][0] = (arr[0][0] == 1) ? 2 : 1;
        arr[3][1] = (arr[3][1] == 1) ? 2 : 1;
        arr[6][2] = (arr[6][2] == 1) ? 2 : 1;
        arr[1][3] = (arr[1][3] == 1) ? 2 : 1;
        arr[4][4] = (arr[4][4] == 1) ? 2 : 1;
        arr[7][5] = (arr[7][5] == 1) ? 2 : 1;
        arr[2][6] = (arr[2][6] == 1) ? 2 : 1;
        arr[5][7] = (arr[5][7] == 1) ? 2 : 1;
        arr[8][8] = (arr[8][8] == 1) ? 2 : 1;
